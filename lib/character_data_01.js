...
var X = (
  ...
  '\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003' +
  '\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003' +
  '\003\003\003\003\003\003\003\003\003\003\003\003\003\003\003').split('');
...
var Y = (
  ...
  '\003\003\003\003\003\003\003\003\003\003').split('');
...
var B = (
  ...
  '\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000' +
  '\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000' +
  '\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000\000').split('');
...
function CharacterData01() {}

var proto = CharacterData01.prototype;

proto.getProperties = function(ch) {
  var offset = ch;
  var props = A[(Y[(X[offset >> 5] << 4) | ((offset >> 1) & 0xF)] << 1) | (offset & 0x1)];
  return props;
};

proto.getPropertiesEx = function(ch) {
  var offset = ch;
  var props = B[(Y[(X[offset >> 5] << 4) | ((offset >> 1) & 0xF)] << 1) | (offset & 0x1)];
  return props;
};
...
exports.instance = new CharacterData01();
